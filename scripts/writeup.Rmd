...
contacts %>% 
  ...
  labs(title = "More females donate across all age groups than males",
       subtitle = paste0("Do younger donors not like to disclose their gender?", emo::ji("thinking")),
       x = "Age",
...
contacts %>% 
  ...
  labs(title = "Most older donors identify as Christian",
       subtitle = paste0("Do younger donors not like to disclose their religion?", emo::ji("thinking")),
       x = "Age",
